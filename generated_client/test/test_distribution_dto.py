...
from openapi_client.models.distribution_dto import DistributionDTO  # noqa: E501
...
class TestDistributionDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DistributionDTO:
        """Test DistributionDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DistributionDTO`
        """
        model = DistributionDTO()  # noqa: E501
        if include_optional:
