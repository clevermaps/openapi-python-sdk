...
class OrderByDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderByDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderByDTO:
        """Create an instance of OrderByDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderByDTO.parse_obj(obj)

        _obj = OrderByDTO.parse_obj({
