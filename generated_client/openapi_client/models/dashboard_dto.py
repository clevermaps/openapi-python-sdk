...
class DashboardDTO(BaseModel):
    ...
    description: Optional[constr(strict=True, max_length=2000, min_length=1)] = None
    content: DashboardContentDTO = Field(...)
    ...
    def from_dict(cls, obj: dict) -> DashboardDTO:
        ...
        _obj = DashboardDTO.parse_obj({
            ...
            "content": DashboardContentDTO.from_dict(obj.get("content")) if obj.get("content") is not None else None
        })
        return _obj
