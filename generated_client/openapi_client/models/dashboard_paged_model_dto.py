...
class DashboardPagedModelDTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardPagedModelDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardPagedModelDTO:
        """Create an instance of DashboardPagedModelDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardPagedModelDTO.parse_obj(obj)

        _obj = DashboardPagedModelDTO.parse_obj({
