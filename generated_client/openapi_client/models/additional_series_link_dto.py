...
class AdditionalSeriesLinkDTO(BaseModel):
    """
    AdditionalSeriesLinkDTO
    """
    indicator: constr(strict=True) = Field(...)
    __properties = ["indicator"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalSeriesLinkDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalSeriesLinkDTO:
        """Create an instance of AdditionalSeriesLinkDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdditionalSeriesLinkDTO.parse_obj(obj)

        _obj = AdditionalSeriesLinkDTO.parse_obj({
