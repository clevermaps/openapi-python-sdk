...
class ActiveGlobalDateFilterDTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActiveGlobalDateFilterDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActiveGlobalDateFilterDTO:
        """Create an instance of ActiveGlobalDateFilterDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActiveGlobalDateFilterDTO.parse_obj(obj)

        _obj = ActiveGlobalDateFilterDTO.parse_obj({
